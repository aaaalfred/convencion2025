 ...
 *
 * Ejecutar: node scripts/setup-rekognition-esm.js
 */
...
async function verificarSetup() {
  ...
  try {
    ...
    console.log(`  1. Iniciar servidor: ${colors.cyan}npm run server${colors.reset}`);
    console.log(`  2. Iniciar frontend: ${colors.cyan}npm run dev${colors.reset}`);
